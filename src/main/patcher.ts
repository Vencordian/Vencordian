...
console.log("[Vencordian] Starting up...");
...
if (!IS_VANILLA) {
    ...
    console.log("[Vencordian] Running in vanilla mode. Not loading Vencord");
}

console.log("[Vencordian] Loading original Discord app.asar");
