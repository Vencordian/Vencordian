            ...
            <ErrorBoundary>
                <ModalRoot {...props} size={ModalSize.DYNAMIC} fullscreenOnMobile={true} >
                    <ModalHeader className={cl("header")}>
                        <Forms.FormText style={{ fontSize: "1.2rem", fontWeight: "bold", marginRight: "7px" }}>Members with role {
                        ...
                        <div style={{ padding: "13px 20px" }} className={cl("member-list")}>
                            {
                                ...
                                ) : <Forms.FormText>It looks like no online cached members with that role were found. Try scrolling down on your member list to cache more users!</Forms.FormText>
                            }
                        </div>
                    </ModalContent>
                </ModalRoot>
